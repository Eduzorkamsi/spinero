      ...
      <div className="delivery_box2">
        <div className="form-column">
          <div className="form-group">
            <label className="input_label_text" for="inputName">First name</label>
          ...
          <div className="form-group">
            <label className="input_label_text" for="inputName">Last name</label>
          ...
          <div className="form-group ">
            <label className="input_label_text" for="inputNumber">Phone number</label>
        ...
        <div className="form-group">
          <label className="input_label_text" for="inputAddress">Address</label>
        ...
        <div className="form-row">
          <div className="form-group col-md-6">
            <label className="input_label_text" for="inputCity">City</label>
          ...
          <div className="form-group col-md-6">
            <label className="input_label_text" for="inputState">State</label>
