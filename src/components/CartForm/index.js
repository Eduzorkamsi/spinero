...
const CartForm = ({ addressInformation = {}, handleInputChange, children }) => {
  ...
  return (
    <>
      <div className="delivery_box2 col-sm-12 col-xs-12 mt-5">
        <div className="form-column mx-sm-4 mb-2 px-5">
        ...
        <div className="form-neither mx-sm-4 mb-2 px-5">
        <div className="form-group ">
        ...
        <div className="form-row mx-sm-4 mb-2 px-5">
